...
class ApiResponseAdapter(private var items: List<ru.messenger.app1.models.ApiResponse>) : RecyclerView.Adapter<ApiResponseAdapter.ApiResponseViewHolder>() {
    ...
    inner class ApiResponseViewHolder(private val binding: ListItemBinding) :
        ...
        fun bind(apiResponse: ru.messenger.app1.models.ApiResponse) {
